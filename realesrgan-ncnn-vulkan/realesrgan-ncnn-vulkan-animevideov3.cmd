...
realesrgan-ncnn-vulkan.exe -i _inputs -o _tmp -n realesr-animevideov3
for %%a in ("_tmp\*.png") do (
   call scale.bat -source "%%~fa" -target "_outputs-animevideov3\%%~nxa" -max-height 2500 -keep-ratio yes -force yes
)
