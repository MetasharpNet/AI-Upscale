...
realcugan-ncnn-vulkan.exe -f png -i _inputs -o _tmp -m models-se -n 0
for %%a in ("_tmp\*.png") do (
   call scale.bat -source "%%~fa" -target "_outputs-se\%%~nxa" -max-height 2500 -keep-ratio yes -force yes
)
